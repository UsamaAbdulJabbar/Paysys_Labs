                ...
                <div class="row-table">
                    ...
                    <div class="col-cell header-quote">
                        ...
                        if($rs_show_cart != 'hide'){
                            if(!empty($reobiz_option['wc_cart_icon'])) { ?>
                        ...
                        if($rs_show_quote != 'hide'){
                            if(!empty($reobiz_option['quote_btns']) || ($rs_show_quote == 'show') ){ ?>
                                <?php if($quote_btn_texts !=''){
                                       $quote_btns_link = !empty($reobiz_option['quote_btns_link']) ? 'tatget="_blank"' : '';
                                 ?>
                                <div class="btn_quote"><a href="<?php echo esc_url($reobiz_option['quote_link']); ?>" <?php echo wp_kses_post($quote_btns_link);?> class="quote-button"><?php  echo esc_html($reobiz_option['quote']); ?></a></div>                                            
                                    ...
                                    <?php } else {
                                        ...
                                        <div class="btn_quote">
                                            <a href="<?php echo esc_url($reobiz_option['quote_link']); ?>" class="quote-button"><?php  echo esc_html($reobiz_option['quote']); ?>                                            
                                            </a>
                                        </div>
                                    <?php } }
                                ?>  
