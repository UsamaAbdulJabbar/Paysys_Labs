...
if($rs_top_bar != 'hide'){
    if(!empty($reobiz_option['show-top']) || ($rs_top_bar == 'show')){
       ...
       if( !empty($reobiz_option['top-email']) || !empty($reobiz_option['phone']) || !empty($reobiz_option['show-social'])){?> 
          ...
          <div class="toolbar-area ff <?php echo esc_attr($show_topbar_mobile); ?>">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <div class="toolbar-sl-share">
                    <ul class="clearfix">
                      <?php
                      if(!empty($reobiz_option['open_hours'])):
                        $open_hours = $reobiz_option['open_hours']; ?>
                         <li class="opening"> <i class="glyph-icon reobizicon-clock"></i> <?php echo esc_html($open_hours); ?> </li>
