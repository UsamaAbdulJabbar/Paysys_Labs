<?php
    ...
    if($banner_hide !='hide'){ 
    if(!empty($reobiz_option['off_banner_blog_single_all']) || $banner_hide =='show'){ 
        return;
    } else {
...
elseif (!empty($reobiz_option['blog_banner']['url'])) {?>
<div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $reobiz_option['blog_banner']['url'] );?>')">
    <div class="<?php echo esc_attr($header_width);?>">
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
