...
add_action( 'cmb2_admin_init', 'rs_register_onepage_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function rs_register_onepage_metabox() {
	$prefix = 'rsonepage_'; 
	$cmb_single_menu = new_cmb2_box( array(
		'id'            => $prefix . 'metabox-project',
		'title'         => esc_html__( 'Onepage Settings', 'rs-framework' ),
		'object_types'  => array( 'page' ), // Post type
		'show_names'   => false,
		'context'    => 'side',
	) );

	$cmb_single_menu->add_field( array(
		'name'             => esc_html__( 'Onepage Style', 'rs-framework' ),
		'desc'             => esc_html__( 'Please Check Onepage Demo', 'rs-framework' ),
		'id'               => 'onepages_select',
		'type'             => 'checkbox'		
	));
}
  ...
  /**
	...
	$cmb_demo->add_field( array(
		...
		'options'          => array(
			...
			'header4' => esc_html__( 'Header Style 2', 'rs-framework' ),
			'header3' => esc_html__( 'Header Style 3', 'rs-framework' ),
			'header6' => esc_html__( 'Header Style 4', 'rs-framework' ),
			'header7' => esc_html__( 'Header Style 5', 'rs-framework' ),
			'header8' => esc_html__( 'Header Style 6', 'rs-framework' ),
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'Choose Quote Button Bg color', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Button Background Color (Sticky)', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Button Background color (Sticky)', 'cmb2' ),
		'id'      => 'quote_button_bg_colord',
		'type'    => 'colorpicker',
		'default' => '',		
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Button Color (Sticky)', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Button color (Sticky)', 'cmb2' ),
		'id'      => 'quote_button_colord',
		'type'    => 'colorpicker',
		'default' => '',		
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Button Hover Bg color (Sticky)', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Button Bg Border color (Sticky)', 'cmb2' ),
		'id'      => 'quote_button_bg_hover_colord',
		'type'    => 'colorpicker',
		'default' => '',		
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Button Hover Color (Sticky)', 'cmb2' ),
		'desc'    => esc_html__( 'Choose Button Hover color (Sticky)', 'cmb2' ),
		'id'      => 'quote_button_hover_colord',
		'type'    => 'colorpicker',
		'default' => '',		
	) );
}
...
add_action( 'cmb2_admin_init', 'rs_register_logos_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function rs_register_logos_metabox() {
	$prefix = 'rs_logos_'; 
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Logo Settings', 'rs-framework' ),
		'object_types'  => array( 'mp-event','page','post','teams','portfolios','services','product','archive' ), // Post type
	) );
...
// Topbar Settings
add_action( 'cmb2_admin_init', 'rs_register_topbar_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function rs_register_topbar_metabox() {
	$prefix = 'rs_tops_'; 
...
// Menu Settings
add_action( 'cmb2_admin_init', 'rs_register_menus_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function rs_register_menus_metabox() {
	$prefix = 'rs_menus_'; 
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Menu Settings', 'rs-framework' ),
		'object_types'  => array( 'mp-event','page','post','teams','portfolios','services','product','archive' ), // Post type
	) );
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Menu Item Top Padding', 'rs-framework' ),
		'desc'    => esc_html__( 'example(45px)', 'rs-framework' ),
		'default' => esc_attr__( '45px', 'rs-framework' ),
		'id'      => 'menu_item_top',
		'type'    => 'text_medium',
	) );

	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Menu Item Bottom Padding', 'rs-framework' ),
		'desc'    => esc_html__( 'example(45px)', 'rs-framework' ),
		'default' => esc_attr__( '45px', 'rs-framework' ),
		'id'      => 'menu_item_bottom',
		'type'    => 'text_medium',
...
// Offcanvas Settings
add_action( 'cmb2_admin_init', 'rs_register_offcanvas_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function rs_register_offcanvas_metabox() {
	$prefix = 'rs_offcanvas_'; 
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Offcanvas Settings', 'rs-framework' ),
		'object_types'  => array( 'mp-event','page','post','teams','portfolios','services','product','archive' ), // Post type
	) );
