...
class Rsaddon_Elementor_Pro_Blog_Slider_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'RS Posts Slider', 'rsaddon' );
    }
    ...
    protected function register_controls() {       
        ...
        $this->start_controls_section(
         ...
         $this->add_control(
            ...
            [
                'label' => esc_html__( 'Select posts by:', 'prelements' ),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    'recent'    => esc_html__( 'Recent Post', 'prelements' ),
                    'yes'       => esc_html__( 'Selected Post', 'prelements' ),
                    ''        => esc_html__( 'Category Post', 'prelements' ),
                ],
            ]
        ); 
        ...
        $this->add_control(
            'select_posts',
            [
                'label'   => esc_html__( 'Select Posts', 'prelements' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Offset', 'prelements' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-item .blog-content h3.blog-name a:hover, {{WRAPPER}} .rs-blog-grid .blog-item .blog-content:hover h3.blog-name a' => 'color: {{VALUE}};',
                ],                
            ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => 
                    '{{WRAPPER}} .blog-item .blog-content .post-categories li a',
            ]
        );
        $this->add_responsive_control(
        ...
        $this->start_controls_section(
            '_blog_image_style',
            [
                'label' => esc_html__( 'Blog Image Style', 'rsaddon' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_responsive_control(
            'blog_image_grayscale',
            [
                'label' => esc_html__( 'Blog Image Grayscale', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item:hover .image-wrap img' => 'filter: grayscale({{SIZE}}%);',  
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-blog-grid .blog-item.blog_style_2.slick-slide:hover .blog-content .blog-btn-part2 a:hover, {{WRAPPER}} .blog-item .blog-content .blog-btn,  {{WRAPPER}} .blog-item .blog-content .custom-blog-btn:hover, {{WRAPPER}} .blog-item .blog-content .blog-btn ' => 'color: {{VALUE}};',
                ],
            ]
        );
