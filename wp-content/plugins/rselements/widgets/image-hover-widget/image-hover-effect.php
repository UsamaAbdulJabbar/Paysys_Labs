                    ...
                    <div class="image-content normal_content">
                            ...
                            <?php if(!empty($settings['image_title_prefix'])){ ?>
                                <div class="title-part">
                                    <div class="prefix-part">
                                        <div <?php  echo $this->print_render_attribute_string( 'image_title_prefix' ); ?>> <?php echo esc_html($settings['image_title_prefix']);?> </div>
                                    </div> 
                                </div>
                            <?php } ?>
                            ...
                            <?php if(!empty($settings['image_description_text'])){ ?>
                                <div class="description-part">
                                    <div <?php  echo $this->print_render_attribute_string( 'image_description_text' ); ?>> <?php echo $settings['image_description_text'];?> </div>
                                </div>
                            <?php } ?>
                ...
                <div class="image-content hover_content">
                    ...
                    <?php if(!empty($settings['image_title_prefix'])){ ?>
                        <div class="title-part">
                            <div class="prefix-part">
                                ...
                                <div <?php  echo $this->print_render_attribute_string( 'image_title_prefix' ); ?>> <?php echo esc_html($settings['image_title_prefix']);?></div></a>
                            </div> 
                        </div>
                    <?php } ?>
                    ...
                    <?php if(!empty($settings['image_btn_text']) || $settings['btn_icon'] ){ ?>
                        <div class="button-part">
                            ...
                            ?>
                            <a class="image-btn <?php echo esc_html($btn_icon_position); ?>" href="<?php echo esc_url($settings['btn_link']['url']);?>" <?php  echo $this->print_render_attribute_string( 'image_btn_text' ); ?>>             
                                <span <?php echo $this->print_render_attribute_string('image_btn_text');?>><?php echo esc_html($settings['image_btn_text']);?></span>
