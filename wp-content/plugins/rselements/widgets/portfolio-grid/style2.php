<?php 
	...
	?>	
                ...
                <div class="portfolio-content">
                	<div class="p-icon">
                		<?php if($settings['grid_popup']=='popup'): ?>
                        	<a class="pointer-events" href="#rs_port2_<?php echo esc_attr($unique);?>" data-effect="mfp-zoom-in"><i class="fa fa-search"></i></a>
                        <?php else: ?>
                	...
                	<?php if(get_the_title()):?>
                		...
                		<div class="p-title">
                			...
                			<?php if($settings['grid_popup']=='popup'): ?>
                				<a class="pointer-events" href="#rs_port2_<?php echo esc_attr($unique);?>" data-effect="mfp-zoom-in"><?php the_title();?></a>
                			<?php else: ?>
		...
		<div id="rs_port2_<?php echo esc_attr($unique);?>" class="rspopup_style1 mfp-with-anim mfp-hide" <?php echo wp_kses_post($popup_port_background);?>>
			<div class="rsteam_content">
				<h3 class="title" <?php echo wp_kses_post($popup_port_title_color);?>><?php the_title();?></h3>
				<div class="team-des" <?php echo $popup_port_content_color;?>>
					<?php the_content(); ?>
				</div>			
