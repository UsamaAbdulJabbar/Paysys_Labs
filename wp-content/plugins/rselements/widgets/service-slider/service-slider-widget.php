...
class Rsaddon_pro_services_Widget extends \Elementor\Widget_Base {
    /**
     * Get widget name.
     *
    ...
    protected function register_controls() {       
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider.rs-services-slider .rs-service-slider .service-title .title:hover' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'show_title' => 'yes'
                ],
