        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .rs-flip-box .rs-flip-box-inner .front-part .front-content-part .front-icon-part span img' => 'width: {{SIZE}}{{UNIT}}; height: auto;',
                    ],
                    'condition' => [
                        'front_icon_type' => 'image'
                    ],
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .rs-flip-box .rs-flip-box-inner .back-part .back-content-part .back-icon-part span img' => 'width: {{SIZE}}{{UNIT}}; height: auto;',
                    ],
                    'condition' => [
                        'front_icon_type' => 'image'
                    ],
        ...
        <div class="rs-flip-box-inner <?php echo esc_attr($settings['flip_position']);?>">
            <div class="rs-flip-box-wrap">
                <div class="front-part">
                    <?php $front_btn_link_target = $settings['front_btn_link']['is_external'] ? 'target=_blank' : '';?>
                    <div class="front-content-part">
                        ...
                        <?php if(!empty($settings['front_btn_text'])) : ?>
                            <div class="front-btn-part">
                                <a class="front-btn <?php echo esc_attr($settings['front_btn_icon_position']);?>" href="<?php echo esc_url($settings['front_btn_link']['url']);?>" <?php echo esc_attr($front_btn_link_target);?>>
                ...
                <div class="back-part">
                    <?php $back_btn_link_target = $settings['back_btn_link']['is_external'] ? 'target=_blank' : '';?>
                    <div class="back-content-part">
                        ...
                        <?php if(!empty($settings['back_btn_text'])) : ?>
                            <div class="back-btn-part">
                                <a class="back-btn <?php echo esc_attr( $settings['back_btn_icon_position'] );?>" href="<?php echo esc_url($settings['back_btn_link']['url']);?>" <?php echo esc_attr($back_btn_link_target);?>>
