...
class Rsaddon_Elementor_pro_RSIcon_Box_Widget extends \Elementor\Widget_Base {
	 ...
	 */
		...
		$this->add_control(
			'icon_position',
			[
				'label'   => esc_html__( ' Icon/Image Position', 'rsaddon' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'icon',			
				'options' => [					
					'top' => esc_html__( 'Top', 'rsaddon'),
					'bottom' => esc_html__( 'Botton', 'rsaddon'),
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .rs-iconbox-area .box-inner:hover .services-btn-part .services-btn, {{WRAPPER}} .rs-iconbox-area .box-inner .services-btn-part:focus .services-btn' => 'color: {{VALUE}};',
		        ],
		    ]
		);
	...
	protected function render() {
		...
		<div class="rs-iconbox-area <?php echo esc_attr($animation_box);?>">
		    <div class="box-inner">
			    	...
			    	<?php if( !empty($settings['selected_icon']) || !empty($settings['selected_image']['url'])){?>
			    		...
			    		<div class="icon-area <?php echo esc_attr( $animation ); ?>">
				    		...
				    		<?php if(!empty($settings['selected_image'])) :?>
				    			<?php if ($settings['title_link']['url']) { ?>
			    ...
			    <div class="text-area">
			    	<?php if(!empty($settings['title'])){ ?>
				    	<div class="iconbox-title">
				    		...
				    		<<?php echo esc_html($settings['title_tag']);?> <?php echo $this->print_render_attribute_string('title'); ?>> 
				    		<?php if ($settings['title_link']['url']) { ?>
				    			<a href="<?php echo esc_url($settings['title_link']['url']);?>" <?php echo $target; ?> <?php echo $nofollow; ?>><?php echo esc_html($settings['title']);?></a>
				    		<?php } else { ?>
			    ...
			    <?php if('top' == $settings['icon_position']){ ?>
			        <?php if(!empty($settings['services_btn_link'])){ ?>
	    		    	<div class="services-btn-part">
	    		    		...
	    		    		?>
	    		    			<a class="services-btn <?php echo esc_attr($icon_position) ?>" href="<?php echo esc_url($settings['services_btn_link']);?>" <?php echo  $link_open; ?>>
			    ...
			    <div <?php echo $this->print_render_attribute_string('badge_title'); ?>><?php echo esc_html ($settings['badge_title']);?></div>
			    <?php } ?>
