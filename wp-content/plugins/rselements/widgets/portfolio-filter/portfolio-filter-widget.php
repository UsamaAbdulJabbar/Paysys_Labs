...
class Rsaddon_Portfolio_pro_Filter_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {		
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .portfolio-item .portfolio-content:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',           
                ],               
            ]
        );
        ...
        $this->add_responsive_control(
            'menu_radius',
            [
                'label' => esc_html__( 'Menu Border Radius', 'rsaddon' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
        ...
        $this->add_group_control(
		    ...
		    [
		        'name' => 'menu_active_shadow',
		        'label' => esc_html__( 'Menu Active Shadow', 'rsaddon' ),
		        'exclude' => [
		            'box_shadow_position',
		        ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon' => 'background: {{VALUE}};',                    
                ],              
            ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .rs-portfolio-style6 .portfolio-item .portfolio-content:before',
                'condition' => [
	...
	?>
		<div class="rs-portfolio-style<?php echo esc_attr($settings['portfolio_grid_style']); ?> rsaddon_pro_box">
			...
			<?php if('filter_show' == $settings['show_filter']){?>
				<div class="portfolio-filter">
				    ...
				    <?php 
						...
						if (is_array($select_cat) || is_object($select_cat))
						{
			...
			<div class="grid row <?php echo esc_html($settings['gap_conditon']);?>">
