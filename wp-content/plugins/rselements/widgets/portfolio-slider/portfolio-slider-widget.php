...
class Rsaddon_Portfolio_Slider_Pro_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio-slider.slider-style-6 .portfolio-item .portfolio-content .p-title > a:hover, {{WRAPPER}} .slider-style-5 .rs-portfolio4 .portfolio-item .portfolio-inner .p-title a:hover, {{WRAPPER}} rs-portfolio .portfolio-item .p-title a:hover' => 'color: {{VALUE}};',                    
                ],                
            ]
	...
	protected function render() {
		...
		<div class="rsaddon-unique-slider rs-addon-slider rs-portfolio-slider rs-portfolio rs-portfolio-style<?php echo esc_attr($settings['portfolio_slider_style']); ?> slider-style-<?php echo esc_attr($settings['portfolio_slider_style']); ?> ">
