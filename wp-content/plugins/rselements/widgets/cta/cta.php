		...
		<div class="rs-cta">
			<div class="cta-content">
				<?php if(!empty($settings['cta_title'])):?>
			        <div class="cta-title">
			            ...
			            <<?php echo esc_attr($settings['title_tag']);?> class="title"> 
			            	<a <?php echo $this->print_render_attribute_string('cta_title');?> href="<?php echo esc_url($settings['cta_link']['url']);?>" <?php echo esc_attr($target);?>>				
				...
				<?php if(!empty($settings['cta_desc'])):?>
			        <div class="cta-text">
			            <p <?php echo $this->print_render_attribute_string('cta_desc');?>> <?php echo wp_kses_post ($settings['cta_desc']);?></p>
			        </div>
				<?php endif;?>
			</div>
