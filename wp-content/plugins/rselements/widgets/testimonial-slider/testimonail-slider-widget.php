...
class Rsaddon_Pro_Testimonial_Slider_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'arrow_position',
            [
                'label' => esc_html__( 'Arrow Top/Bottom Position', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .slick-arrow' => 'top: {{SIZE}}{{UNIT}}; position:absolute',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'arrow_position_left',
            [
                'label' => esc_html__( 'Arrow Left/Right Position', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ '%' ],
                'range' => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rsaddon-unique-slider .slick-prev' => 'left: {{SIZE}}%; position:absolute',
                    '{{WRAPPER}} .rsaddon-unique-slider .slick-next' => 'right: {{SIZE}}%; position:absolute',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'dots_bdr_color',
            [
                'label' => esc_html__( 'Background (Normal)', 'prelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .rsaddon-unique-slider .slick-dots li button' => 'background: {{VALUE}};',],
            ]
        );
        ...
        $this->add_control(
            'dots_bg',
            [
                'label' => esc_html__( 'Background (Active)', 'prelements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .rsaddon-unique-slider .slick-dots li.slick-active button, {{WRAPPER}} .rsaddon-unique-slider .slick-dots li button:hover' => 'background: {{VALUE}};',],
            ]
        );
        $this->add_responsive_control(
            'dotss_top_position',
            [
                'label' => esc_html__( 'Bottom/Top Position', 'rsaddon' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    '%' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-slider .slick-dots' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $nav_dot_style = $settings['navigation_dots_style'] ?? '';
        ...
        ?>  
            <div class="rsaddon-unique-slider rs-testimonial-grid rs-testimonial rs_nav_dost<?php echo esc_attr($nav_dot_style);?>">
