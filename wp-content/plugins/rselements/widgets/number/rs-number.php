			    ...
			    <div class="number-text">
			    	<?php if(!empty($settings['number_prefix'])) : ?>
			    		<div class="number-area">
				    		<span <?php echo $this->print_render_attribute_string('number_prefix'); ?>>
			    	...
			    	<?php if(!empty($settings['title'])){ ?>
				    	<div class="number-title">
				    		...
				    		<<?php echo esc_html( $settings['title_tag'] );?> class="title"> <a <?php echo $this->print_render_attribute_string('title'); ?> href="<?php echo esc_url($settings['title_link']);?>" <?php echo $link_open; ?>><?php echo esc_html($settings['title']);?></a></<?php echo  esc_html( $settings['title_tag'] );?>>
				    		<?php else: ?>
	    	    	...
	    	    	<?php if(!empty($settings['number_btn_text'])){ ?>
	    		    	...
	    		    	<div class="number-btn-part">
	    		    		...
	    		    		?>
    		    			<a class="number-btn <?php echo esc_attr( $icon_position ); ?>" href="<?php echo esc_url($settings['number_btn_link']);?>" <?php echo  $link_open; ?>>

    		    				<span <?php echo $this->print_render_attribute_string('number_btn_text');?>><?php echo esc_html( $settings['number_btn_text'] );?></span>
