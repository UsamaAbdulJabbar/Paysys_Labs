        ...
        $this->start_controls_section(
 		...
 		$repeater->add_control(
 		    ...
 		    [
 		        ...
 		        'label_block' => true,
 		        'options' => [
					'fab fa-500px'          => esc_html__( '500px', 'rsaddon' ),
					'fab fa-apple'          => esc_html__( 'Apple', 'rsaddon' ),
					'fab fa-behance'        => esc_html__( 'Behance', 'rsaddon' ),		          
					'fab fa-codepen'        => esc_html__( 'CodePen', 'rsaddon' ),				
					'fab fa-digg'           => esc_html__( 'Digg', 'rsaddon' ),
					'fab fa-dribbble'       => esc_html__( 'Dribbble', 'rsaddon' ),		           
					'fab fa-facebook-f'       => esc_html__( 'Facebook', 'rsaddon' ),
					'fab fa-flickr'         => esc_html__( 'Flicker', 'rsaddon' ),
					'fab fa-foursquare'     => esc_html__( 'FourSquare', 'rsaddon' ),
					'fab fa-github'         => esc_html__( 'Github', 'rsaddon' ),
					'fab fa-houzz'          => esc_html__( 'Houzz', 'rsaddon' ),
					'fab fa-instagram'      => esc_html__( 'Instagram', 'rsaddon' ),
					'fab fa-jsfiddle'       => esc_html__( 'JS Fiddle', 'rsaddon' ),
					'fab fa-linkedin-in'       => esc_html__( 'LinkedIn', 'rsaddon' ),
					'fab fa-medium-m'         => esc_html__( 'Medium', 'rsaddon' ),
					'fab fa-pinterest-p'      => esc_html__( 'Pinterest', 'rsaddon' ),
					'fab fa-product-hunt'   => esc_html__( 'Product Hunt', 'rsaddon' ),
					'fab fa-reddit'         => esc_html__( 'Reddit', 'rsaddon' ),
					'fab fa-slideshare'     => esc_html__( 'Slide Share', 'rsaddon' ),
					'fab fa-snapchat-ghost'       => esc_html__( 'Snapchat', 'rsaddon' ),
					'fab fa-soundcloud'     => esc_html__( 'SoundCloud', 'rsaddon' ),
					'fab fa-spotify'        => esc_html__( 'Spotify', 'rsaddon' ),
					'fab fa-stack-overflow' => esc_html__( 'StackOverflow', 'rsaddon' ),
					'fa fa-tripadvisor'    => esc_html__( 'TripAdvisor', 'rsaddon' ),
					'fab fa-tumblr'         => esc_html__( 'Tumblr', 'rsaddon' ),
					'fab fa-twitch'         => esc_html__( 'Twitch', 'rsaddon' ),
					'fab fa-twitter'        => esc_html__( 'Twitter', 'rsaddon' ),
					'fab fa-vimeo-v'          => esc_html__( 'Vimeo', 'rsaddon' ),
					'fab fa-vk'             => esc_html__( 'VK', 'rsaddon' ),
					'far fa-browser'        => esc_html__( 'Website', 'rsaddon' ),
					'fab fa-whatsapp'       => esc_html__( 'WhatsApp', 'rsaddon' ),
					'fab fa-wordpress'      => esc_html__( 'WordPress', 'rsaddon' ),
					'fab fa-xing'           => esc_html__( 'Xing', 'rsaddon' ),
					'fab fa-yelp'           => esc_html__( 'Yelp', 'rsaddon' ),
					'fab fa-youtube'        => esc_html__( 'YouTube', 'rsaddon' ),					
				],
 		        'separator'   => 'before',
 		    ]
 		);
 		...
 		$this->add_control(
 		    ...
 		    [
 		        ...
 		        'default' => [
                    [
                        'link' => '#',
                        'social_profile' => 'fab fa-facebook-f',
                    ],
                    [
                        'link' => '#',
                        'social_profile' => 'fab fa-twitter',
                    ],
                    [
                        'link' => '#',
                        'social_profile' => 'fab fa-linkedin-in',
                    ],                  
                ],
 		    ]
 		);
	...
	protected function render() {
		...
		if($settings['team_grid_source'] == 'dynamic'){
			...
			<div class="rs-team-grid rs-team team-grid-<?php echo esc_html($settings['team_grid_style']);?> <?php echo esc_html($settings['team_grid_popup']);?> rsaddon_pro_box">
				...
				<div class="team-item">
					<div class="team-inner-wrap">
						<div class="image-wrap">
							...
							<div class="social-icons1 sdf">	
								<?php foreach ( $settings['social_icon_list'] as $index => $item ) :

									$target       = !empty($item['link']['is_external']) ? 'target=_blank' : '';                    
				            		$link         = !empty($item['link']['url']) ? $item['link']['url'] : ''; ?>
				            								
									<a href="<?php echo esc_url($link);?>"  <?php echo $target;?> class="social-icon">
				...
				<div id="rs_popupBox_<?php echo esc_attr($unique);?>" class="rspopup_style1 mfp-with-anim mfp-hide" <?php echo $popup_background;?>>
					<div class="row">
						<div class="col-md-5">
							...
							<div class="rsteam_content">
								<div class="team-content">
									<div class="team-heading">
									  	...
									  	<?php if($settings['title']) : ?>
								  		<h3 class="team-name"><a class="pointer-events" href="#rs_popupBox_<?php echo esc_attr($unique);?>" data-effect="mfp-zoom-in"><?php echo esc_html($settings['title']);?></a></h3>
								  		<?php endif; ?>
									...
									<div class="team-des" <?php echo $popup_content_color;?>>
									...
									<div class="contact-info">
										...
										<ul>
											<?php if($settings['phone']): ?>
												<li <?php echo $popup_phn_email_color;?>>
											...
											<?php if($settings['email']): ?>
												<li <?php echo $popup_phn_email_color;?>>
													...
													<a href="mailto:<?php echo esc_attr($show_email); ?>"<?php echo $popup_phn_email_color;?>>
