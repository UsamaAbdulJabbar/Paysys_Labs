                    ...
                    foreach ( $settings['logo_list'] as $index => $item ) :
                        ...
                        <div class="col-lg-<?php echo esc_attr($settings['columns']);?> col-md-6 col-xs-1 <?php echo esc_attr( $gap );?>">
                            <div  class="rs-grid-figure">
                                <div class="logo-img">
                                    <a href="<?php echo esc_url($link);?>" <?php echo $target;?>><img class="rs-grid-img <?php echo esc_attr( $animation ); ?>" <?php echo esc_attr( $show_tooltip );?> src="<?php echo esc_url( $image ); ?>" title="<?php echo esc_attr( $item['name'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>"></a>
                                </div>
